...
export default function TransactionStatusTester() {
    ...
    const handleTest = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("/api/daraja-test/transaction-status", {
                method: "POST",
    ...
    return (
        <div className="space-y-6">
            <Card>
                <CardHeader>
                    <CardTitle>Transaction Status Query</CardTitle>
                    <CardDescription>
                        Check the status of a specific transaction using its checkout request ID.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="space-y-2 md:col-span-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="e.g., ws_CO_DMZ_xxxxx"
                                        value={testParams.checkoutRequestId}
                                        onChange={handleParamChange}
                                        required
                                    />
                                    <p className="text-xs text-muted-foreground">
                                        The CheckoutRequestID from the STK Push response
                                    </p>
                                </div>
                                <div className="space-y-2">
